    ...
    fun createProfile(name: String) {
        screenModelScope.launch {
            ...
            runCatching {
                ...
                when(it) {
                    is HttpRequestException -> mutableState.value = State.Error(Res.string.network_error)
                    else -> mutableState.value = State.Error(Res.string.unknown_error.format(it.message ?: ""))
                }
            }
        }
    }
